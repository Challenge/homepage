...
//De vigtigtste værdier er samlet her så man hurtigt kan ændre dem hvis man finder det nødvendigt.
	...
	/* list of white lised chars for the name textfields remember to define both 
	 * small and capital letters */
	$whitelisted_name_chars = array('æ', 'Æ', 'ø', 'Ø', 'å', 'Å');
	$encoded_whitelist = array();

	foreach($whitelisted_name_chars as $char){
		$encoded_whitelist[] = htmlentities($char);
	}	
