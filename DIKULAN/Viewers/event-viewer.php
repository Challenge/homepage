	...
	class eventViewer{
		private $selectFrom = 'SELECT event_id, event_name, DATE_FORMAT(event_start,\'%H:%i\'), DATE_FORMAT(event_end,\'%H:%i\')
			    FROM EVENTTABLE ';
		private $dbcon;
	...
	<td><?php echo convertStr($row[2]); ?></td>
	<td><?php echo convertStr($row[3]); ?></td>
		</tr>
