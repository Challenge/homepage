...
$noSelectionErrorText = "Der er ikke blevet valgt nogle pladser. \\n Du kan vælge pladser ved at trykke på et eller flere borde nedenfor. ";
$undefinedTicketErrorText = "Indtast venligst billet ID";
$undefinedNameErrorText = "Indtast venligst billet Navn";
...
global $succesDest;
	...
	if(sizeof($changeArray) > 0){
		...
		foreach($changeArray as $index => $change){
			$t = explode('_',$change);
			$str.= "Billet id: $t[2] plads er blevet ændret til plads: $t[0] og navn: $t[1]\\n";	
		}
	}
