...
<div id="mainView" > 
	<div id="mainDiv">
		...
		if(isset($_REQUEST['delete'])){
			...
			if($succes == '00000'){
			?>		
					<p> Reservationen for billet id: <?php echo $delete ?> er nu blevet annueleret </p>	
			<?php
				}else{ 
			?>
					<p> Der er ikke nogen reservation til det indtastede billet id</p>	
			<?php
				}
			?>
				<input id="deleteTextBox" class="textbox" type="text" value="<?php echo $delete; ?>"> </input>
			<?php
